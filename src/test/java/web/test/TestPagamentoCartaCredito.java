...
public class TestPagamentoCartaCredito {
    ...
    @Test
    void testLoginUserGiornale() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, ParseException, SQLException, ParseException, SQLException {
