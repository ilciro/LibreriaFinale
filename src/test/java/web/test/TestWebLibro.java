...
class TestWebLibro {
    ...
    private final DownloadBean dB=new DownloadBean();
     ...
     @Test
    void testPagamentoCashEDownloadLibro() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, SQLException {
        ...
        //schermata index
         ...
         PropertyUtils.setProperty(lB,"listaLibriB", lD.getLibri());
