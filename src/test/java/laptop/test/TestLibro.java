...
class TestLibro {
    ...
    void testInizializzazioneOggetti()  {
        //used for populate cc
        cc1.setTipo(Integer.parseInt(RBCARTACREDITO.getString("tipo1")));
        //pagamento era
        cc1.setNumeroCC(RBCARTACREDITO.getString("numero1"));
        cc1.setLimite(Double.parseDouble(RBCARTACREDITO.getString("limite")));
        cc1.setAmmontare(Double.parseDouble(RBCARTACREDITO.getString("ammontare1")));
        cc1.setScadenza(dataS);
        cc1.setNomeUser(RBCARTACREDITO.getString("nome1"));
        //pagamento era
        cc1.setPrezzoTransazine(Float.parseFloat(RBCARTACREDITO.getString("prezzoTransazione1")));

        cc2.setNomeUser(RBCARTACREDITO.getString("nome2"));
        cc2.setCognomeUser(RBCARTACREDITO.getString("cognome2"));
        cc2.setNumeroCC(RBCARTACREDITO.getString("numero2"));
        cc2.setCiv(RBCARTACREDITO.getString("civ2"));
        cc2.setScadenza(dataS);
        cc2.setAmmontare(Float.parseFloat(RBCARTACREDITO.getString("ammontare2")));
    ...
    void testAnnullaOrdineL() throws SQLException, IdException {
        ...
        p.setNomeUtente(RBPAGAMENTO.getString("nomeUser"));
        ...
        p2.setNomeUtente(RBPAGAMENTO.getString("nomeUser"));
        p2.setAmmontare(Float.parseFloat(RBPAGAMENTO.getString("spesa2")));
        p2.setTipo(RBPAGAMENTO.getString("tipo2"));
    ...
    void testAggiungiCartaDBL() throws SQLException, IdException {
        ...
        cPCC.aggiungiCartaDB(RBCARTACREDITO.getString("nome1"),RBCARTACREDITO.getString("cognome1"),RBCARTACREDITO.getString("numero1"), data, RBCARTACREDITO.getString("civ1"), Float.parseFloat(RBCARTACREDITO.getString("prezzo")));
        assertNotNull(data);
    }
    @Test
