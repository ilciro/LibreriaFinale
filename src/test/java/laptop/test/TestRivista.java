...
class TestRivista {
   ...
   private final ResourceBundle RBSETTAOGGETTO=ResourceBundle.getBundle("configurations/settaOggetto");
    ...
    void testTotaleR() throws SQLException, IdException {
        ...
        r.setCopieRim(Integer.parseInt(RBSETTAOGGETTO.getString("copieRimanentiR")));
    ...
    void testAggiungiCartaDBR() throws SQLException, IdException {
        ...
        cPCC.aggiungiCartaDB(REBARTADICREDITO.getString("nome2"),REBARTADICREDITO.getString("cognome2"),REBARTADICREDITO.getString("numero2"), data, REBARTADICREDITO.getString("civ2"), Float.parseFloat(REBARTADICREDITO.getString("prezzo2")));
        assertNotNull(data);
    }
