...
class TestLaptopBean {
	...
	@Test
	void testCreaLibro() throws SQLException
	{
		...
		lB.setTitoloB(l.getTitolo());
		lB.setCodIsbnB(l.getCodIsbn());
		lB.setEditoreB(l.getEditore());
		lB.setAutoreB(l.getAutore());
		lB.setLinguaB(l.getLingua());
		lB.setDataPubbB(LocalDate.now());
		lB.setRecensioneB(l.getRecensione());
		lB.setNrCopieB(l.getNrCopie());
		lB.setDisponibilitaB(l.getDisponibilita());
		lB.setNumeroPagineB(l.getNumeroPagine());
